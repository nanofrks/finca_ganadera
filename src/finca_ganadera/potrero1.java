 ...
 * @author nanis
 */
public class potrero1 extends javax.swing.JFrame {

    /**
     * Creates new form potrero1
     */
    ...
    public potrero1() {
        initComponents();
        tabla_modelo=(DefaultTableModel)t_potrero1.getModel(); 
        llenar();
    }
    ...
    public void llenar(){
        try{
            ...
            int p = adm.potrero1.length;
            potrero = new String[p][3];
            
            for(int i=0;i<potrero.length;i++){
                potrero[i][0] = adm.potrero1[i][0];
                VInfo_ganado[0]=potrero[i][0];
                
                potrero[i][1] = adm.potrero1[i][1];
                VInfo_ganado[1]=potrero[i][1];
                
                potrero[i][2] = adm.potrero1[i][3];
    ...
    private void initComponents() {
        ...
        t_potrero1 = new javax.swing.JTable();
        ...
        t_potrero1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        t_potrero1.setName("t_potrero1"); // NOI18N
        jScrollPane1.setViewportView(t_potrero1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(potrero1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable t_potrero1;
